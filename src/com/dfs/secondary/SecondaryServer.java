...
import com.dfs.heartbeats.HeartbeatsManager;
...
public class SecondaryServer implements HeartbeatsListener, SecondaryServerInterface {
    ...
    HeartbeatsManager hearbeatsManager;
    Logger logger;
...
//                              System.out.println("Attempt failed");
        ...
        this.hearbeatsManager = new HeartbeatsManager(this, 100);
        this.hearbeatsManager.addachResponder(mainServerHeartbeats, 0);
